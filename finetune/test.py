...
def main():
    ...
    test_set = SceneTextDataModule.TEST_BENCHMARK_SUB + SceneTextDataModule.TEST_BENCHMARK + SceneTextDataModule.TEST_BENCHMARK_ARD
    if args.new:
    ...
    result_groups = {
        ...
        'Benchmark ARD': SceneTextDataModule.TEST_BENCHMARK_ARD
    }
    if args.new:
